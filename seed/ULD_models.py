...
def model_ULD_640():
    ...
    MODEL_PATH_d2 = "/content/CryoEM_membranes_top_model_decision_tree/seed/models/640-Detectron2-ULD.pth"
...
def model_ULD_1024():
    ...
    MODEL_PATH_d2 = "/content/CryoEM_membranes_top_model_decision_tree/seed/models/1024-Detectron2-ULD.pth"
