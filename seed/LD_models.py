...
def model_LD_640():
    ...
    MODEL_PATH_d2 = "/content/CryoEM_membranes_top_model_decision_tree/seed/models/640-Detectron2-LD.pt"
...
def model_LD_1024():
    ...
    MODEL_PATH_d2 = "/content/CryoEM_membranes_top_model_decision_tree/seed/models/1024-Detectron2-LD.pt"
