...
def test_image_LD_640():
    ...
    test_ann_path = "/content/CryoEM_membranes_top_model_decision_tree/Custom_Datasets/LD/COCO/test/640/_annotations.coco.json"

    #Detectron2
    reregister_coco(
        "bacteria_LD_OMIM_640_test",
        f"/content/CryoEM_membranes_top_model_decision_tree/Custom_Datasets/LD/COCO/test/640/_filt_annotations.coco.json",
...
def test_image_LD_1024():
    ...
    test_ann_path = "/content/CryoEM_membranes_top_model_decision_tree/Custom_Datasets/LD/COCO/test/1024/_annotations.coco.json"

    #Detectron2
    reregister_coco(
        "bacteria_LD_OMIM_1024_test",
        f"/content/CryoEM_membranes_top_model_decision_tree/Custom_Datasets/LD/COCO/test/1024/_filt_annotations.coco.json",
