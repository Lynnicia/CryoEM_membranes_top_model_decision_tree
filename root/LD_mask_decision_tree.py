...
### mask count
Model = "{model_image_size_decision}-Detectron2"
Model_Image_Size = 1024
Model_Electron_Dose = "LD"
Test_Image_Size = 1024    # TARGET_SIZE
Test_Electron_Dose = "LD"
...
cfg.MODEL.WEIGHTS = "/content/drive/MyDrive/content/bacteria-thickness_additional-6/LD-OMIM-Detectron2_1024_03-02-2026_19-37-03/output/best_model.pth"
